...
import { GraduationCap, Laptop, MapPin, ExternalLink, ArrowRight, ArrowLeft } from 'lucide-react';
...
export function SkillDevelopmentPrograms({ onContinue, onBack }: SkillDevelopmentProgramsProps) {
